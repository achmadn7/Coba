...
class MahasiswasControllerTest < ActionController::TestCase
  ...
  test "should create mahasiswa" do
    assert_difference('Mahasiswa.count') do
      post :create, mahasiswa: { alamat: @mahasiswa.alamat, nama: @mahasiswa.nama, nim: @mahasiswa.nim, tanggal_lahir: @mahasiswa.tanggal_lahir }
    end
  ...
  test "should update mahasiswa" do
    patch :update, id: @mahasiswa, mahasiswa: { alamat: @mahasiswa.alamat, nama: @mahasiswa.nama, nim: @mahasiswa.nim, tanggal_lahir: @mahasiswa.tanggal_lahir }
    assert_redirected_to mahasiswa_path(assigns(:mahasiswa))
  end
